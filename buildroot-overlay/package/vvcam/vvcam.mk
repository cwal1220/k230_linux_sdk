...
define VVCAM_BUILD_DEB
	...
	$(call COPYFILE ,$(firstword $(call qstrip,$(BR2_ROOTFS_OVERLAY)))/etc/init.d/S41adb_mtp ,$(@D)/deb/etc/vvcam/)
	$(call COPYFILE ,$(firstword $(call qstrip,$(BR2_ROOTFS_OVERLAY)))/etc/umtprd,$(@D)/deb/etc/)
